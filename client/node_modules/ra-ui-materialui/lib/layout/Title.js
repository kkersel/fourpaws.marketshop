...
var TitleText_1 = require("./TitleText");
var Title = function (_a) {
    ...
    var titleElement = !title ? (React.createElement(TitleText_1.TitleText, __assign({ className: className }, rest, { text: defaultTitle }))) : typeof title === 'string' ? (React.createElement(TitleText_1.TitleText, __assign({ className: className }, rest, { text: translate(title, { _: title }) }))) : (react_1.cloneElement(title, __assign({ className: className, record: record }, rest)));
